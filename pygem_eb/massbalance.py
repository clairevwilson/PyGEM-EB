...
class massBalance():
    ...
    def __init__(self,args,climate):
        ...
        self.previous_mass = np.sum(self.layers.ldrymass + self.layers.lwater)
        return
        ...
        if surface.stemp < 0.:
            ...
            if layers.lwater[0] + dm < 0:
                ...
                if layer == layers.nlayers:
                    evaporation = evaporation + dm # there is no water to evaporate
            else:
                layers.lwater[0] += dm
...
class Output():
    ...
    def store_timestep(self,massbal,enbal,surface,layers,step):
        ...
        self.layerrefreeze_output[step] = layers.drefreeze.copy()
